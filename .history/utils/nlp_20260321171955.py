...
from langchain_google_genai import ChatOpenAI # Or substitute with your preferred LLM
import os
...
def analyze_sentiment_with_langchain(ticker, stock_name, api_key):
    ...
    # 2. Initialize LLM
    llm = ChatOpenAI(temperature=0.2, model="gpt-3.5-turbo", openai_api_key=api_key)

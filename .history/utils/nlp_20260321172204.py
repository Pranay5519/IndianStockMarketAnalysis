...
from langchain_core.prompts import PromptTemplatefrom langchain_google_genai import ChatGoogleGenerativeAI # Or substitute with your preferred LLM
import os
...
def analyze_sentiment_with_langchain(ticker, stock_name, api_key):
    ...
    # 2. Initialize LLM
    llm = ChatGoogleGenerativeAI(temperature=0.2, model="gemini-2.5-flash", api_key = api_key)
